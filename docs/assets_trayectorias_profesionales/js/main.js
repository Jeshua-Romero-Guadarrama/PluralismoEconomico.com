;(function () {
	...
	var burgerMenu = function() {
		...
		$('body').on('click', '.js-JeshuaRomeroGuadarrama-nav-toggle', function(event){
	...
	var clickMenu = function() {
		...
		$('#navbar a:not([class="external"])').click(function(event){
		    ...
		    if ( navbar.is(':visible')) {
		    	...
		    	$('.js-JeshuaRomeroGuadarrama-nav-toggle').removeClass('active');
		    }
	...
	var windowScroll = function() {
		...
		$(window).scroll(function(event){
		   	...
		   	var header = $('#JeshuaRomeroGuadarrama-header'),
				scrlTop = $(this).scrollTop();

			if ( scrlTop > 500 && scrlTop <= 2000 ) {
				header.addClass('navbar-fixed-top JeshuaRomeroGuadarrama-animated slideInDown');
			} else if ( scrlTop <= 500) {
				if ( header.hasClass('navbar-fixed-top') ) {
					header.addClass('navbar-fixed-top JeshuaRomeroGuadarrama-animated slideOutUp');
					setTimeout(function(){
						header.removeClass('navbar-fixed-top JeshuaRomeroGuadarrama-animated slideInDown slideOutUp');
					}, 100 );
				}
			} 
	...
	var homeAnimate = function() {
		if ( $('#JeshuaRomeroGuadarrama-home').length > 0 ) {	

			$('#JeshuaRomeroGuadarrama-home').waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {


					setTimeout(function() {
						$('#JeshuaRomeroGuadarrama-home .to-animate').each(function( k ) {
							var el = $(this);
	...
	var exploreAnimate = function() {
		...
		var explore = $('#JeshuaRomeroGuadarrama-explore');
		if ( explore.length > 0 ) {	
	...
	var testimonyAnimate = function() {
		var testimony = $('#JeshuaRomeroGuadarrama-testimony');
	...
	var pricingAnimate = function() {
		var pricing = $('#JeshuaRomeroGuadarrama-pricing');
		if ( pricing.length > 0 ) {	
	...
	var servicesAnimate = function() {
		var services = $('#JeshuaRomeroGuadarrama-services');
	...
	var teamAnimate = function() {
		var team = $('#JeshuaRomeroGuadarrama-team');
		if ( team.length > 0 ) {	
	...
	var faqAnimate = function() {
		var faq = $('#JeshuaRomeroGuadarrama-faq');
		if ( faq.length > 0 ) {	
	...
	var trustedAnimate = function() {
		var trusted = $('#JeshuaRomeroGuadarrama-trusted');
		if ( trusted.length > 0 ) {	
	...
	var footerAnimate = function() {
		var footer = $('#JeshuaRomeroGuadarrama-footer');
		if ( footer.length > 0 ) {	
	...
	var blogAnimate = function() {
		var footer = $('#JeshuaRomeroGuadarrama-blog');
		if ( footer.length > 0 ) {	
	...
	var counterWayPoint = function() {
		if ($('#JeshuaRomeroGuadarrama-counter-section').length > 0 ) {
			$('#JeshuaRomeroGuadarrama-counter-section').waypoint( function( direction ) {
